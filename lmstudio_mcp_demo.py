...
async def demo_mcp_with_lmstudio():
    ...
    hrm_request = create_mcp_request("tools/call", {
        "name": "query_agent",
        "arguments": {
            "agent_type": "hrm",
    ...
    trm_request = create_mcp_request("tools/call", {
        "name": "query_agent",
        "arguments": {
            "agent_type": "trm",
    ...
    mcts_request = create_mcp_request("tools/call", {
        "name": "run_mcts",
        "arguments": {
    ...
    health_request = create_mcp_request("tools/call", {
        "name": "health_check",
        "arguments": {}
    })
