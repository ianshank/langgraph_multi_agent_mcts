...
def mock_transformers():
    with patch("src.agents.common.system_encoder.AutoTokenizer") as enc_tok, \
        ...
        enc_output_mock.__getitem__.side_effect = lambda k: torch.ones(1, 10) # support ["input_ids"] access if needed or **kwargs
