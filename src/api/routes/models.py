...
from src.api.dependencies import get_orchestrator, get_registry
...
async def register_model(
    model_type: str = Form(...), file: UploadFile = File(...), registry: ModelRegistry = Depends(get_registry)
):
    ...
    try:
        ...
        v_id = registry.register_model(source_path=tmp_path, model_type=model_type, metrics={}, tags=["api-upload"])
