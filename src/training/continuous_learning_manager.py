...
class ContinuousLearningManager:
    ...
    def _register_and_promote(
        ...
        model_type: str,
        sub_components: dict[str, str] | None = None
    ):
        ...
        if best_version:
             ...
             if current_loss < best_loss:
                 ...
                 logger.info(f"New model {version_id} ({current_loss:.4f}) not better than {best_version.version_id} ({best_loss:.4f}).")
        else:
             # First model
