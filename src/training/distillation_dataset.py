...
class DistillationDataset(Dataset):
    ...
    def _prepare_trm_sample(self, example: TrainingExample) -> dict[str, Any]:
        ...
        return {
            ...
            "target_code": example.test_results.get("refined_code", example.state_code) if example.test_results else example.state_code,
